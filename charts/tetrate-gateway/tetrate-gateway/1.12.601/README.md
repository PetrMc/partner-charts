...
This chart is OSS Upstream and uses images installed in the cluster already. 
We strongly recommend to use [Tetrate Istio Distro](https://istio.tetratelabs.io/) as simple, safe enterprise-grade Istio distro. 
